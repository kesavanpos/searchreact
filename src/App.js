          ...
          <div className="search-section">
            ...
            <div className="options-content">
              <div className="options">
                <label><input type="radio" name="trip-type" /><span>One Way</span></label>
              </div>
              <div className="options">
                <label><input type="radio" name="trip-type" /><span>Return</span></label>
              </div>
              <div className="options">
                <label><input type="radio" name="trip-type" /><span>Open Return</span></label>
              </div>
              <div className="options">
                <label><input type="radio" name="trip-type" /><span>Seasons</span></label>
              </div>
            </div>

            <input type="date" className="form-control context-setting" placeholder="Travel date" ></input>
            <input type="date" className="form-control context-setting" placeholder="Return date"></input>
          </div>
